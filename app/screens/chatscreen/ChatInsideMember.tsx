                ...
                <Container>
                    ...
                    <ModalOverlay activeOpacity={1}>
                        <BottomSheetContent>
                            ...
                            <BottomSheetSubTitle>If the report does not meet the reason for the report{"\n"}the report will not be processed</BottomSheetSubTitle>
                            <ReasonBox onPress={openReportModal}><ReasonText>Spam</ReasonText></ReasonBox>
                            <ReasonBox onPress={openReportModal}><ReasonText>Sexual Activity</ReasonText></ReasonBox>
